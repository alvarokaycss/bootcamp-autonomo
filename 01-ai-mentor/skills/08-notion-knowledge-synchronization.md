# 08 — Notion Knowledge Synchronization
...
### 1. Registrar informação relevante, não volume de conversa

O mentor deve evitar transformar o Notion em histórico bruto de mensagens.
...
- conversas sem impacto na evolução.
...
### 3. Manter rastreabilidade da evolução
...
Quando o aluno demonstra domínio suficiente de um conceito.

### Gap identificado
Quando existe uma lacuna que impacta a progressão.

### Decisão técnica relevante
Quando o aluno analisa alternativas e escolhe uma solução justificadamente.
...
- Essa informação muda a compreensão sobre o aluno?
- Existe evidência suficiente para registrar?
- Qual competência está relacionada?
